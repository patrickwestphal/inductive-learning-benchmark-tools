...
config = {
    ...
    'url': 'https://github.com/patrickwestphal/inductive-learning-benchmark-tools',
    'download_url': 'https://github.com/patrickwestphal/inductive-learning-benchmark-tools',
